        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate-fade-in flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center lg:items-start sm:items-center gap-3 sm:gap-6 pt-6 text-xs sm:text-sm text-amber-100/60 w-full lg:w-auto">
            ...
            <div className="relative animate-scale-in">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-amber-500/30 border border-amber-400/20 h-[400px] sm:h-[500px] lg:h-[700px]">
                <img 
