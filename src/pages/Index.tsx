  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-fuchsia-950 via-violet-900 to-rose-950 text-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-tight uppercase" style={{letterSpacing: '0.12em', fontFamily: 'Poppins, sans-serif', fontWeight: 900}}>
                <div className="premium-gold-text strikethrough-line mb-2 sm:mb-4">
                  ИЗ УСТАЛОСТИ
                </div>
                <div className="premium-gold-text">
                  В ГОРЯЩИЙ ГЛАЗ
                </div>
              </h1>
      ...
      <section id="program" className="relative py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16 animate-fade-in">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 leading-tight text-glow-gold">
            ...
            <p className="text-xl sm:text-2xl md:text-3xl font-semibold bg-gradient-to-r from-fuchsia-400 to-amber-400 bg-clip-text text-transparent">
              с 9—22 февраля
            </p>
          </div>
      ...
      <section className="relative py-20 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 md:mb-6 text-glow-gold">
              Почему именно <span className="bg-gradient-to-r from-fuchsia-400 via-amber-400 to-white bg-clip-text text-transparent">9 февраля?</span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {[
              ...
              { icon: "Crown", color: "text-fuchsia-300", title: "ЛИЧНОЕ СОПРОВОЖДЕНИЕ", desc: "2 недели после завершения квеста Дарья поддерживает лично тебя (только VIP)." }
            ].map((item, index) => (
              <div 
                key={index}
